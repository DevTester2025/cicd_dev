...
export default (sequelize: SequelizeStatic.Sequelize) => {
  return sequelize.define<AssetsInstance, AssetsAttributes>(
    "Assets-Document",
    {
      ...
      mimetype: SequelizeStatic.STRING(100),
      filename: SequelizeStatic.STRING(100),
      filesize: SequelizeStatic.STRING(100),
      comment: SequelizeStatic.TEXT,
      url: SequelizeStatic.STRING(500),
    },
    {
      timestamps: false,
      freezeTableName: true,
      tableName: "tbl_assets_document",
    }
  );
};
