...
export class Controller {
  ...
  all(req: Request, res: Response): void {
    ...
    try {
      ...
      commonService
        .getAllList(parameters, db.ecl2instancetype)
        .then((list) => {
  ...
  byId(req: Request, res: Response): void {
    ...
    try {
      commonService
        .getById(req.params.id, db.ecl2instancetype)
        .then((data) => {
          customValidation.generateSuccessResponse(
            data,
            response,
  ...
  create(req: Request, res: Response): void {
    ...
    try {
      commonService
        .create(req.body, db.ecl2instancetype)
        .then((data) => {
          customValidation.generateSuccessResponse(
            data,
            response,
  ...
  update(req: Request, res: Response): void {
    ...
    try {
      ...
      commonService
        .update(condition, req.body, db.ecl2instancetype)
        .then((data) => {
          customValidation.generateSuccessResponse(
            data,
            response,
