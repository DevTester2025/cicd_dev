...
export class Controller {
  ...
  all(req: Request, res: Response): void {
    ...
    try {
      ...
      CommonService.getAllList(parameters, db.KpiUptime)
        .then((list) => {
  ...
  byId(req: Request, res: Response): void {
    let response = {};
    try {
      CommonService.getById(req.params.id, db.KpiUptime)
        .then((data) => {
          customValidation.generateSuccessResponse(
            data,
            response,
  ...
  create(req: Request, res: Response): void {
    let response = {};
    try {
      CommonService.create(req.body, db.KpiUptime)
        .then((data) => {
          customValidation.generateSuccessResponse(
            data,
            response,
  ...
  update(req: Request, res: Response): void {
    ...
    try {
      ...
      CommonService.update(condition, req.body, db.KpiUptime)
        .then((data) => {
          customValidation.generateSuccessResponse(
            data,
            response,
  ...
  delete(req: Request, res: Response): void {
    ...
    try {
      ...
      CommonService.update(condition, { status: "Deleted" }, db.KpiUptime)
        .then((data) => {
          customValidation.generateSuccessResponse(
            data,
            response,
