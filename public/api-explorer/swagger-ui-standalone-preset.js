    ...
    function (e, t, r) {
      ...
      var o = r(34),
        ...
        l = [
          ...
          c.default,
          function () {
            return { components: { StandaloneLayout: s.default } };
          },
        ];
      e.exports = l;
    },
            ...
            a(t, [
              {
                ...
                value: function () {
                  ...
                  return c.default.createElement(
                    ...
                    o ? c.default.createElement(o, null) : null,
                    "loading" === l &&
                    ...
                    !l || ("success" === l && c.default.createElement(a, null)),
                    c.default.createElement(
                      n,
                      null,
                      c.default.createElement(
                        s,
                        null,
                        c.default.createElement(u, null)
                      )
                    )
                  );
                },
	...
	*/
    ...
    function (e, t, r) {
      ...
      function u(e, t, r) {
        ...
        Array.isArray(u)
          ? c(u, n, r, g.thatReturnsArgument)
          : null != u &&
            (m.isValidElement(u) &&
              (u = m.cloneAndReplaceKey(
                u,
                s + (!u.key || (t && t.key === u.key) ? "" : i(u.key) + "/") + r
              )),
            n.push(u));
      }
    ...
    function (e, t) {
      ...
      function r(e) {
        for (
          ...
          r += "&args[]=" + encodeURIComponent(arguments[i + 1]);
        r +=
    ...
    function (e, t, r) {
      ...
      var s = r(5),
        ...
        l = function (e, t, r, i, n, s, o) {
          var a = { $$typeof: u, type: e, key: t, ref: r, props: o, _owner: s };
          return a;
        };
        ...
        if (Array.isArray(e))
          ...
          if (y) {
            var D,
              b = y.call(e);
            if (y !== e.entries)
              for (var v = 0; !(D = b.next()).done; )
                (f = D.value), (d = g + i(f, v++)), (m += n(f, d, r, s));
            else
              for (; !(D = b.next()).done; ) {
                var w = D.value;
                w &&
                  ((f = w[1]),
                  (d = g + c.escape(w[0]) + h + i(f, 0)),
                  (m += n(f, d, r, s)));
              }
          } else if ("object" === p) {
            var E = "",
    ...
    function (e, t, r) {
      ...
      function n(e, t) {
        ...
        w.hasOwnProperty(t) && ("OVERRIDE_BASE" !== r ? p("73", t) : void 0),
          e &&
      ...
      function s(e, t) {
        if (t) {
          "function" == typeof t ? p("75") : void 0,
            m.isValidElement(t) ? p("76") : void 0;
          var r = e.prototype,
      ...
      function a(e, t) {
        ...
        for (var r in t)
          t.hasOwnProperty(r) &&
            (void 0 !== e[r] ? p("81", r) : void 0, (e[r] = t[r]));
        return e;
      }
      function u(e, t) {
        return function () {
      ...
      var p = r(8),
        ...
        v = {
          ...
          mixins: function (e, t) {
            if (t) for (var r = 0; r < t.length; r++) s(e, t[r]);
          },
    ...
    function (e, t, r) {
          ...
          if (!Array.isArray(a)) {
            ...
            return new n(
              "Invalid " +
                ...
                o +
                "` of type " +
                ("`" + c + "` supplied to `" + i + "`, expected an array.")
            );
          }
          for (var l = 0; l < a.length; l++) {
            var h = e(a, l, i, s, o + "[" + l + "]", E);
      ...
      function h(e) {
        function t(t, r, s, o, a) {
          for (var u = t[r], c = 0; c < e.length; c++)
            if (i(u, e[c])) return null;
          var l = w[o],
            h = JSON.stringify(e);
          return new n(
            "Invalid " +
              ...
              u +
              "` " +
              ("supplied to `" + s + "`, expected one of " + h + ".")
          );
        }
        return Array.isArray(e) ? s(t) : k.thatReturnsNull;
      }
      function p(e) {
        function t(t, r, i, s, o) {
          if ("function" != typeof e)
          ...
          if ("object" !== u) {
            ...
            return new n(
              "Invalid " +
                ...
                o +
                "` of type " +
                ("`" + u + "` supplied to `" + i + "`, expected an object.")
            );
          }
          for (var l in a)
      ...
      function f(e) {
        function t(t, r, i, s, o) {
          for (var a = 0; a < e.length; a++) {
            var u = e[a];
            if (null == u(t, r, i, s, o, E)) return null;
          }
          var c = w[s];
          return new n(
            "Invalid " + c + " `" + o + "` supplied to " + ("`" + i + "`.")
          );
        }
        return Array.isArray(e) ? s(t) : k.thatReturnsNull;
      }
      ...
      (n.prototype = Error.prototype), (e.exports = S);
    },
    function (e, t) {
      "use strict";
      ...
      function n(e) {
        for (var t = [], r = {}, i = 0; i < e.length; i++) {
          var n = e[i],
            ...
            a = n[2],
            u = n[3],
            c = { css: o, media: a, sourceMap: u };
          r[s] ? r[s].parts.push(c) : t.push((r[s] = { id: s, parts: [c] }));
        }
        return t;
      }
      function s(e, t) {
    ...
    function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = function () {
          return { components: { Topbar: s.default } };
        });
      var n = r(35),
        s = i(n);
    },
          ...
          function t(e, r) {
            ...
            return (
              ...
              (i.downloadUrl = function (e) {
                i.props.specActions.updateUrl(i.state.url),
                  i.props.specActions.download(i.state.url),
                  e.preventDefault();
              }),
              (i.state = { url: e.specSelectors.url() }),
              i
            );
          }
          return (
    ...
    function (e, t, r) {
      ...
      function n(e) {
        ...
        return { statePlugins: { spec: { actions: r, selectors: i } } };
      }
    ...
    function (e, t, r) {
      ...
      var n = r(40),
        s = r(72);
      (e.exports.Type = r(46)),
        (e.exports.Schema = r(45)),
        (e.exports.FAILSAFE_SCHEMA = r(49)),
        (e.exports.JSON_SCHEMA = r(48)),
        (e.exports.CORE_SCHEMA = r(47)),
        (e.exports.DEFAULT_SAFE_SCHEMA = r(44)),
        (e.exports.DEFAULT_FULL_SCHEMA = r(67)),
        ...
        (e.exports.YAMLException = r(42)),
        (e.exports.MINIMAL_SCHEMA = r(49)),
        (e.exports.SAFE_SCHEMA = r(44)),
        (e.exports.DEFAULT_SCHEMA = r(67)),
    ...
    function (e, t, r) {
      ...
      function g(e, t, r, i) {
        ...
        if (t < r) {
          if (((a = e.input.slice(t, r)), i))
            ...
            Q.test(a) && d(e, "the stream contains non-printable characters");
          e.result += a;
        }
      }
      function x(e, t, r, i) {
        ...
        for (
          ...
          (s = n[o]), K.call(t, s) || ((t[s] = r[s]), (i[s] = !0));
      }
      ...
      function b(e, t, r) {
        for (var s = 0, o = e.input.charCodeAt(e.position); 0 !== o; ) {
          ...
          if (!i(o)) break;
          for (
            D(e), o = e.input.charCodeAt(e.position), s++, e.lineIndent = 0;
            32 === o;
      ...
      function v(e) {
        ...
        return (
          ...
          !(
            ...
            ((r += 3), (t = e.input.charCodeAt(r)), 0 !== t && !s(t))
          )
        );
      }
      function w(e, t) {
      ...
      function E(e, t, r) {
        ...
        if (
          (63 === m || 45 === m) &&
          ((u = e.input.charCodeAt(e.position + 1)), s(u) || (r && o(u)))
        )
          return !1;
        for (
          e.kind = "scalar", e.result = "", c = l = e.position, h = !1;
          0 !== m;

        ) {
          if (58 === m) {
            if (((u = e.input.charCodeAt(e.position + 1)), s(u) || (r && o(u))))
              break;
          } else if (35 === m) {
          ...
          h &&
            (g(e, c, l, !1), w(e, e.line - p), (c = l = e.position), (h = !1)),
            n(m) || (l = e.position + 1),
            (m = e.input.charCodeAt(++e.position));
        }
      ...
      function k(e, t) {
        ...
        for (
          e.kind = "scalar", e.result = "", e.position++, n = s = e.position;
          ...
          if (39 === r) {
            ...
            i(r)
              ? (g(e, n, s, !0), w(e, b(e, !1, t)), (n = s = e.position))
              : e.position === e.lineStart && v(e)
              ? d(
                  e,
      ...
      function A(e, t) {
        ...
        for (
          ...
          if (92 === l) {
            ...
            i(l)
              ? (g(e, r, n, !0), w(e, b(e, !1, t)), (r = n = e.position))
              : e.position === e.lineStart && v(e)
              ? d(
                  e,
      ...
      function S(e, t) {
        ...
        for (e.kind = "scalar", e.result = ""; 0 !== a; )
          if (((a = e.input.charCodeAt(++e.position)), 43 === a || 45 === a))
            V === u
              ? (u = 43 === a ? Z : $)
        ...
        for (; 0 !== a; ) {
          for (
            D(e), e.lineIndent = 0, a = e.input.charCodeAt(e.position);
            (!h || e.lineIndent < p) && 32 === a;
      ...
      function F(e, t) {
        ...
        for (
          ...
          0 !== n &&
          45 === n &&
          ((i = e.input.charCodeAt(e.position + 1)), s(i));

        )
          if (((c = !0), e.position++, b(e, !0, -1) && e.lineIndent <= t))
            u.push(null), (n = e.input.charCodeAt(e.position));
          else if (
            ((r = e.line),
            P(e, t, q, !1, !0),
            u.push(e.result),
      ...
      function T(e, t, r) {
        ...
        for (
          ...
          if (
            ...
            if (e.line === a) {
              for (c = e.input.charCodeAt(e.position); n(c); )
                c = e.input.charCodeAt(++e.position);
              if (58 === c)
                (c = e.input.charCodeAt(++e.position)),
                  s(c) ||
          ...
          if (
            ((e.line === a || e.lineIndent > t) &&
              (P(e, t, G, !0, o) && (D ? (g = e.result) : (x = e.result)),
              D || (y(e, p, f, m, g, x, a, u), (m = g = x = null)),
              b(e, !0, -1),
              (c = e.input.charCodeAt(e.position))),
            e.lineIndent > t && 0 !== c)
          )
        ...
        return (
          D && y(e, p, f, m, g, null),
          v &&
            ((e.tag = l), (e.anchor = h), (e.kind = "mapping"), (e.result = p)),
          v
        );
      }
      function B(e) {
        ...
        if (
          ...
          (n = e.input.charCodeAt(++e.position)),
          60 === n
            ? ((o = !0), (n = e.input.charCodeAt(++e.position)))
            : 33 === n
            ? ((a = !0), (r = "!!"), (n = e.input.charCodeAt(++e.position)))
            : (r = "!"),
          (t = e.position),
          o)
        ) {
          ...
          (i = e.input.slice(t, e.position)),
            te.test(i) &&
              d(e, "tag suffix cannot contain flow indicator characters");
        }
        return (
          i &&
            !ie.test(i) &&
            d(e, "tag name cannot contain such characters: " + i),
          o
            ? (e.tag = i)
            : K.call(e.tagMap, r)
            ? (e.tag = e.tagMap[r] + i)
      ...
      function I(e) {
        ...
        return (
          ...
          e.anchorMap.hasOwnProperty(r) ||
            d(e, 'unidentified alias "' + r + '"'),
      ...
      function P(e, t, r, i, n) {
        ...
        if (
          ...
          if ("?" === e.tag) {
            ...
            K.call(e.typeMap[e.kind || "fallback"], e.tag)
      ...
      function M(e) {
        ...
        for (
          ...
          for (
            c = !0, a = e.input.charCodeAt(++e.position), t = e.position;
            0 !== a && !s(a);
          ...
          0 !== a && D(e),
            K.call(ae, r)
              ? ae[r](e, r, o)
              : m(e, 'unknown document directive "' + r + '"');
        }
        return (
          b(e, !0, -1),
          0 === e.lineIndent &&
          ...
          45 === e.input.charCodeAt(e.position + 2)
            ...
            : c && d(e, "directives end mark is expected"),
          P(e, e.lineIndent - 1, G, !1, !0),
          b(e, !0, -1),
          e.checkLineBreaks &&
            ee.test(e.input.slice(u, e.position)) &&
      ...
      function U(e, t, r) {
        L(e, t, z.extend({ schema: J }, r));
      }
      function _(e, t) {
        return R(e, z.extend({ schema: J }, t));
      }
      for (
        var z = r(41),
          j = r(42),
      ...
      var ae = {
        YAML: function (e, t, r) {
          ...
          null !== e.version && d(e, "duplication of %YAML directive"),
            ...
            (n = parseInt(i[1], 10)),
            (s = parseInt(i[2], 10)),
            1 !== n && d(e, "unacceptable YAML version of the document"),
            (e.version = r[0]),
        ...
        TAG: function (e, t, r) {
          var i, n;
          2 !== r.length && d(e, "TAG directive accepts exactly two arguments"),
            (i = r[0]),
            (n = r[1]),
            re.test(i) ||
              d(
      ...
      (e.exports.loadAll = L),
        (e.exports.load = R),
        (e.exports.safeLoadAll = U),
        (e.exports.safeLoad = _);
    },
    function (e, t) {
      "use strict";
      function r(e) {
    ...
    function (e, t, r) {
      ...
      e.exports = new i({
        include: [r(49)],
        implicit: [r(53), r(54), r(55), r(56)],
      });
    },
    function (e, t, r) {
      "use strict";
      var i = r(45);
      e.exports = new i({ explicit: [r(50), r(51), r(52)] });
    },
    function (e, t, r) {
      "use strict";
      var i = r(46);
    ...
    function (e, t, r) {
      ...
      function o(e) {
        ...
        return !!a && (":" !== t || /^(:[0-5]?[0-9])+$/.test(e.slice(o)));
      }
      function a(e) {
        var t,
          r,
        ...
        return (
          ...
          (t = i[0]),
          ("-" !== t && "+" !== t) ||
            ("-" === t && (n = -1), (i = i.slice(1)), (t = i[0])),
          "0" === i
            ? 0
            : "0" === t
            ? "b" === i[1]
              ? n * parseInt(i.slice(2), 2)
              : "x" === i[1]
              ? n * parseInt(i, 16)
              : n * parseInt(i, 8)
            : i.indexOf(":") !== -1
    ...
    function (e, t, r) {
      ...
      function n(e) {
        var t,
          ...
          f = 0,
          d = null;
        if (((t = a.exec(e)), null === t && (t = u.exec(e)), null === t))
        ...
        return (
          t[9] &&
            ...
            (d = 6e4 * (60 * l + h)),
            "-" === t[9] && (d = -d)),
          (p = new Date(Date.UTC(r, i, n, s, o, c, f))),
    ...
    function (e, t, r) {
      ...
      function n(e) {
        ...
        for (t = 0; t < n; t++)
          t % 4 === 0 &&
            t &&
            (u.push((o >> 16) & 255), u.push((o >> 8) & 255), u.push(255 & o)),
            (o = (o << 6) | s.indexOf(i.charAt(t)));
        return (
          (r = (n % 4) * 6),
          0 === r
            ? (u.push((o >> 16) & 255), u.push((o >> 8) & 255), u.push(255 & o))
    ...
    function (e, t, r) {
      (function (e) {
        ...
        function B(e) {
          ...
          for (var r = "", i = 0; i < t; )
            r += String.fromCharCode.apply(String, e.slice(i, (i += ee)));
          return r;
        }
        function N(e, t, r) {
          var i = "";
        ...
        function z(e, t, r, i, n) {
          return (
            n || _(e, t, r, 4, 3.4028234663852886e38, -3.4028234663852886e38),
        ...
        function j(e, t, r, i, n) {
          return (
            n || _(e, t, r, 8, 1.7976931348623157e308, -1.7976931348623157e308),
        ...
        (o.prototype.slice = function (e, t) {
          ...
          if (o.TYPED_ARRAY_SUPPORT)
            (i = this.subarray(e, t)), (i.__proto__ = o.prototype);
          else {
            var n = t - e;
            i = new o(n, void 0);
    ...
    function (e, t) {
      ...
      function n(e) {
        ...
        return (
          2 === o
            ? ((s = (c[e.charCodeAt(t)] << 2) | (c[e.charCodeAt(t + 1)] >> 4)),
              (a[h++] = 255 & s))
            : 1 === o &&
              ((s =
                (c[e.charCodeAt(t)] << 10) |
      ...
      function o(e, t, r) {
        for (var i, n = [], o = t; o < r; o += 3)
          (i = (e[o] << 16) + (e[o + 1] << 8) + e[o + 2]), n.push(s(i));
        return n.join("");
      }
      function a(e) {
        for (
            ...
            t = Math.abs(t),
              isNaN(t) || t === 1 / 0
                ...
                : ((o = Math.floor(Math.log(t) / Math.LN2)),
                  ...
                  (t += o + h >= 1 ? p / u : p * Math.pow(2, 1 - h)),
                  t * u >= 2 && (o++, (u /= 2)),
                  o + h >= l
                    ? ((a = 0), (o = l))
                    : o + h >= 1
                    ? ((a = (t * u - 1) * Math.pow(2, n)), (o += h))
                    : ((a = t * Math.pow(2, h - 1) * Math.pow(2, n)), (o = 0)));
            n >= 8;
            e[r + f] = 255 & a, f += d, a /= 256, n -= 8
          );
          for (
            o = (o << n) | a, c += n;
            c > 0;
    ...
    function (e, t, r) {
      ...
      function i(e) {
        ...
        for (t = 0, r = c.length; t < r; t += 1) {
          if (((i = c[t]), (s = !1), "[object Object]" !== a.call(i)))
            return !1;
          for (n in i)
            if (o.call(i, n)) {
              if (s) return !1;
    ...
    function (e, t, r) {
      ...
      function i(e) {
        ...
        var t,
          r = e;
        for (t in r) if (o.call(r, t) && null !== r[t]) return !1;
        return !0;
      }
      function n(e) {
        return null !== e ? e : {};
    ...
    function (e, t, r) {
      ...
      function n(e) {
        ...
        return (
          "/" === t[0] &&
            (r && (i = r[1]), (t = t.slice(1, t.length - i.length - 1))),
          new RegExp(t, i)
        );
      }
      function s(e) {
    ...
    function (e, t, r) {
      ...
      function n(e) {
        ...
        return (
          ...
          new Function(n, r.slice(t[0] + 1, t[1] - 1))
        );
      }
      function s(e) {
        return e.toString();
        ...
        return (function (e) {
            ...
            function i(e, t, r) {
              ...
              h =
                t && "boolean" == typeof t.jsx && t.jsx
                  ? new a.JSXParser(e, t, u)
                  : new o.Parser(e, t, u);
              var p = h.parseProgram();
              return (
                c && (p.comments = i.comments),
              ...
              n = (function () {
                ...
                return (
                  (e.prototype.insertInnerComments = function (e, t) {
                    if (
                      e.type === i.Syntax.BlockStatement &&
                      0 === e.body.length
                    ) {
                      for (
                        var r = [], n = this.leading.length - 1;
                        n >= 0;
                        --n
                      ) {
                  ...
                  (e.prototype.findLeadingComments = function (e, t) {
                    ...
                    if (r) {
                      for (
                        var s = r.leadingComments
                            ? r.leadingComments.length
                            : 0,
                          o = s - 1;
                        o >= 0;
                        --o
                        ...
                        a.range[1] <= t.start.offset &&
                          (i.unshift(a), r.leadingComments.splice(o, 1));
                      }
                      return (
                        r.leadingComments &&
                          0 === r.leadingComments.length &&
                    ...
                    for (var o = this.leading.length - 1; o >= 0; --o) {
                      ...
                      n.start <= t.start.offset &&
                        (i.unshift(n.comment), this.leading.splice(o, 1));
                    }
                    return i;
                  }),
                  ...
                  (e.prototype.visitComment = function (e, t) {
                    var r = "L" === e.type[0] ? "Line" : "Block",
                      i = { type: r, value: e.value };
                    if (
                      (e.range && (i.range = e.range),
                      e.loc && (i.loc = e.loc),
              ...
              h = (function () {
                function e(e, t, r) {
                  void 0 === t && (t = {}),
                    ...
                    (this.sourceType =
                      t && "module" === t.sourceType ? "module" : "script"),
                    (this.lookahead = null),
                ...
                return (
                  ...
                  (e.prototype.unexpectedTokenError = function (e, t) {
                    var r,
                      i = t || n.Messages.UnexpectedToken;
                    if (
                      (e
                        ? (t ||
                            ((i =
                      ...
                      if (e.length > 0 && this.delegate)
                        for (var t = 0; t < e.length; ++t) {
                          ...
                          (i = {
                            ...
                            this.config.range && (i.range = r.range),
                  ...
                  (e.prototype.nextToken = function () {
                    ...
                    return (
                      ...
                      t &&
                        this.context.strict &&
                        t.type === o.Token.Identifier &&
                        this.scanner.isStrictModeReservedWord(t.value) &&
                        (t.type = o.Token.Keyword),
                      (this.lookahead = t),
                      this.config.tokens &&
                        t.type !== o.Token.EOF &&
                  ...
                  (e.prototype.createNode = function () {
                    return {
                      ...
                      line: this.startMarker.lineNumber,
                      column:
                        this.startMarker.index - this.startMarker.lineStart,
                    };
                  }),
                      ...
                      this.config.loc &&
                        ((t.loc = {
                          start: { line: e.line, column: e.column },
                            ...
                            column:
                              this.lastMarker.index - this.lastMarker.lineStart,
                          },
                        }),
                        this.config.source &&
                  ...
                  (e.prototype.expectKeyword = function (e) {
                    var t = this.nextToken();
                    (t.type === o.Token.Keyword && t.value === e) ||
                      this.throwUnexpectedToken(t);
                  }),
                  (e.prototype.match = function (e) {
                    return (
                      this.lookahead.type === o.Token.Punctuator &&
                      this.lookahead.value === e
                    );
                  }),
                  (e.prototype.matchKeyword = function (e) {
                    return (
                      this.lookahead.type === o.Token.Keyword &&
                      this.lookahead.value === e
                    );
                  }),
                  (e.prototype.matchContextualKeyword = function (e) {
                    return (
                      this.lookahead.type === o.Token.Identifier &&
                      this.lookahead.value === e
                    );
                  }),
                  ...
                  (e.prototype.consumeSemicolon = function () {
                    this.match(";")
                      ? this.nextToken()
                      : this.hasLineTerminator ||
                        (this.lookahead.type === o.Token.EOF ||
                          this.match("}") ||
                          this.throwUnexpectedToken(this.lookahead),
                        (this.lastMarker.index = this.startMarker.index),
                        (this.lastMarker.lineNumber =
                          this.startMarker.lineNumber),
                  ...
                  (e.prototype.parsePrimaryExpression = function () {
                    ...
                    switch (this.lookahead.type) {
                      case o.Token.Identifier:
                        "module" === this.sourceType &&
                          "await" === this.lookahead.value &&
                          this.tolerateUnexpectedToken(this.lookahead),
                          (e = this.finalize(
                            s,
                            new c.Identifier(this.nextToken().value)
                          ));
                        break;
                      ...
                      case o.Token.StringLiteral:
                        this.context.strict &&
                          ...
                          (e = this.finalize(s, new c.Literal(r.value, i)));
                        break;
                        ...
                        switch ((t = this.lookahead.value)) {
                          ...
                          case "/=":
                            (this.context.isAssignmentTarget = !1),
                              ...
                              (e = this.finalize(
                                s,
                                new c.RegexLiteral(r.value, i, r.regex)
                              ));
                            break;
                          default:
                        ...
                        this.matchKeyword("yield")
                          ...
                          : ((this.context.isAssignmentTarget = !1),
                            ...
                            this.matchKeyword("function")
                              ...
                              ? (this.nextToken(),
                                (e = this.finalize(s, new c.ThisExpression())))
                  ...
                  (e.prototype.parseArrayInitializer = function () {
                    ...
                    return (
                      this.expect("]"),
                      this.finalize(e, new c.ArrayExpression(t))
                    );
                  }),
                  ...
                  (e.prototype.parsePropertyMethodFunction = function () {
                    ...
                    return (
                      ...
                      this.finalize(
                        t,
                        new c.FunctionExpression(null, i.params, n, e)
                      )
                    );
                  }),
                  ...
                  (e.prototype.parseObjectProperty = function (e) {
                    var t,
                      ...
                      l = !1,
                      h = !1;
                    a.type === o.Token.Identifier
                      ? (this.nextToken(),
                        (r = this.finalize(s, new c.Identifier(a.value))))
                      : this.match("*")
                      ? this.nextToken()
                      : ((u = this.match("[")),
                        (r = this.parseObjectPropertyKey()));
                    var p = this.qualifiedPropertyName(this.lookahead);
                    if (a.type === o.Token.Identifier && "get" === a.value && p)
                      (t = "get"),
                        (u = this.match("[")),
                        (r = this.parseObjectPropertyKey()),
                        (this.context.allowYield = !1),
                        (i = this.parseGetterMethod());
                    else if (
                      a.type === o.Token.Identifier &&
                      "set" === a.value &&
                      p
                      ...
                      (t = "set"),
                        (u = this.match("[")),
                        (r = this.parseObjectPropertyKey()),
                        (i = this.parseSetterMethod());
                    else if (
                      a.type === o.Token.Punctuator &&
                      "*" === a.value &&
                      p
                    )
                      (t = "init"),
                      ...
                      (i = this.parsePropertyMethodFunction()), (l = !0);
                  ...
                  (e.prototype.parseObjectInitializer = function () {
                    ...
                    return (
                      this.expect("}"),
                      this.finalize(e, new c.ObjectExpression(t))
                    );
                  }),
                    ...
                    if ((this.expect("("), this.match(")")))
                      ...
                      if (this.match("..."))
                        ...
                        if (
                          ...
                          var n = [];
                          for (
                            this.context.isAssignmentTarget = !1, n.push(e);
                            this.startMarker.index < this.scanner.length &&
                            this.match(",");
                  ...
                  (e.prototype.isIdentifierName = function (e) {
                    return (
                      e.type === o.Token.Identifier ||
                      e.type === o.Token.Keyword ||
                      e.type === o.Token.BooleanLiteral ||
                      e.type === o.Token.NullLiteral
                    );
                  }),
                  (e.prototype.parseIdentifierName = function () {
                    ...
                    return (
                      ...
                      this.finalize(e, new c.Identifier(t.value))
                    );
                  }),
                    ...
                    function () {
                      ...
                      for (
                        ...
                        if (this.match(".")) {
                          ...
                          r = this.finalize(
                            this.startNode(e),
                            new c.StaticMemberExpression(r, i)
                          );
                        } else if (this.match("(")) {
                          (this.context.isBindingElement = !1),
                            (this.context.isAssignmentTarget = !1);
                          ...
                          this.expect("]"),
                            (r = this.finalize(
                              this.startNode(e),
                              new c.ComputedMemberExpression(r, i)
                            ));
                        } else {
                          if (
                            this.lookahead.type !== o.Token.Template ||
                          ...
                          r = this.finalize(
                            this.startNode(e),
                            new c.TaggedTemplateExpression(r, s)
                          );
                        }
                    ...
                    for (
                      ...
                      if (this.match("[")) {
                        ...
                        this.expect("]"),
                          (t = this.finalize(
                            e,
                            new c.ComputedMemberExpression(t, r)
                          ));
                      } else if (this.match(".")) {
                        (this.context.isBindingElement = !1),
                          (this.context.isAssignmentTarget = !0),
                        ...
                        t = this.finalize(
                          e,
                          new c.StaticMemberExpression(t, r)
                        );
                      } else {
                        if (
                          this.lookahead.type !== o.Token.Template ||
                        ...
                        t = this.finalize(
                          e,
                          new c.TaggedTemplateExpression(t, n)
                        );
                      }
                    return t;
                  }),
                  (e.prototype.parseUpdateExpression = function () {
                    ...
                    if (this.match("++") || this.match("--")) {
                      ...
                      (e = this.finalize(
                        r,
                        new c.UpdateExpression(i.value, e, s)
                      )),
                        (this.context.isAssignmentTarget = !1),
                        (this.context.isBindingElement = !1);
                    } else if (
                  ...
                  (e.prototype.parseUnaryExpression = function () {
                    ...
                    if (
                      ...
                      (e = this.inheritCoverGrammar(this.parseUnaryExpression)),
                        (e = this.finalize(
                          t,
                          new c.UnaryExpression(r.value, e)
                        )),
                        this.context.strict &&
                          "delete" === e.operator &&
                  ...
                  (e.prototype.binaryPrecedence = function (e) {
                    var t,
                      r = e.value;
                    return (t =
                      e.type === o.Token.Punctuator
                        ? this.operatorPrecedence[r] || 0
                        : e.type === o.Token.Keyword &&
                          ("instanceof" === r ||
                            (this.context.allowIn && "in" === r))
                        ? 7
                        : 0);
                  }),
                  (e.prototype.parseBinaryExpression = function () {
                    ...
                    if (i > 0) {
                      ...
                      for (
                        ...
                        if (
                          ((i = this.binaryPrecedence(this.lookahead)), i <= 0)
                        )
                          break;
                        for (; a.length > 2 && i <= a[a.length - 2].prec; ) {
                          ...
                          a.push(
                            this.finalize(l, new c.BinaryExpression(u, s, o))
                          );
                        }
                        (r = this.nextToken()),
                          (r.prec = i),
                      ...
                      for (t = a[h], n.pop(); h > 1; ) {
                        ...
                        (t = this.finalize(
                          l,
                          new c.BinaryExpression(a[h - 1].value, a[h - 2], t)
                        )),
                          (h -= 2);
                      }
                    }
                  ...
                  (e.prototype.parseConditionalExpression = function () {
                    ...
                    if (this.match("?")) {
                      ...
                      (t = this.finalize(
                        this.startNode(e),
                        new c.ConditionalExpression(t, i, n)
                      )),
                        (this.context.isAssignmentTarget = !1),
                        (this.context.isBindingElement = !1);
                    }
                  ...
                  (e.prototype.reinterpretAsCoverFormalsList = function (e) {
                    ...
                    for (var i = 0; i < r.length; ++i) {
                      var s = r[i];
                      s.type === u.Syntax.AssignmentPattern &&
                    ...
                    if (this.context.strict || !this.context.allowYield)
                      for (var i = 0; i < r.length; ++i) {
                        var s = r[i];
                        s.type === u.Syntax.YieldExpression &&
                          this.throwUnexpectedToken(this.lookahead);
                      }
                      ...
                      if (
                        ...
                        if (i) {
                          ...
                          this.context.strict &&
                            ...
                            (e = this.finalize(
                              a,
                              new c.ArrowFunctionExpression(i.params, h, p)
                            )),
                        ...
                        if (
                          (this.context.isAssignmentTarget ||
                            this.tolerateError(
                              n.Messages.InvalidLHSInAssignment
                            ),
                          this.context.strict && e.type === u.Syntax.Identifier)
                        ) {
                          var f = e;
                          this.scanner.isRestrictedWord(f.name) &&
                            this.tolerateUnexpectedToken(
                              r,
                              n.Messages.StrictLHSAssignment
                            ),
                            this.scanner.isStrictModeReservedWord(f.name) &&
                              this.tolerateUnexpectedToken(
                                r,
                        ...
                        (e = this.finalize(
                          this.startNode(t),
                          new c.AssignmentExpression(r.value, e, d)
                        )),
                          (this.context.firstCoverInitializedNameError = null);
                      }
                    }
                  ...
                  (e.prototype.parseBlock = function () {
                    ...
                    return (
                      this.expect("}"),
                      this.finalize(e, new c.BlockStatement(t))
                    );
                  }),
                  (e.prototype.parseLexicalBinding = function (e, t) {
                    ...
                    return (
                      ...
                      this.finalize(r, new c.VariableDeclarator(s, o))
                    );
                  }),
                  ...
                  (e.prototype.isLexicalDeclaration = function () {
                    ...
                    return (
                      (this.scanner.index = e),
                      (this.scanner.lineNumber = t),
                      (this.scanner.lineStart = r),
                      i.type === o.Token.Identifier ||
                        (i.type === o.Token.Punctuator && "[" === i.value) ||
                        (i.type === o.Token.Punctuator && "{" === i.value) ||
                        (i.type === o.Token.Keyword && "let" === i.value) ||
                        (i.type === o.Token.Keyword && "yield" === i.value)
                    );
                  }),
                  (e.prototype.parseLexicalDeclaration = function (e) {
                    ...
                    return (
                      ...
                      this.finalize(t, new c.VariableDeclaration(n, r))
                    );
                  }),
                  ...
                  (e.prototype.parseArrayPattern = function (e, t) {
                    ...
                    return (
                      this.expect("]"), this.finalize(r, new c.ArrayPattern(i))
                    );
                  }),
                  ...
                  (e.prototype.parseObjectPattern = function (e, t) {
                    ...
                    for (this.expect("{"); !this.match("}"); )
                      i.push(this.parsePropertyPattern(e, t)),
                        this.match("}") || this.expect(",");
                    return (
                      this.expect("}"), this.finalize(r, new c.ObjectPattern(i))
                    );
                  }),
                  ...
                  (e.prototype.parseVariableIdentifier = function (e) {
                    var t = this.createNode(),
                      r = this.nextToken();
                    return (
                      r.type === o.Token.Keyword && "yield" === r.value
                        ? (this.context.strict &&
                            this.tolerateUnexpectedToken(
                              r,
                              n.Messages.StrictReservedWord
                        ...
                        : r.type !== o.Token.Identifier
                        ? this.context.strict &&
                          r.type === o.Token.Keyword &&
                      ...
                      this.finalize(t, new c.Identifier(r.value))
                    );
                  }),
                    ...
                    return (
                      this.match("=")
                        ...
                        : i.type === u.Syntax.Identifier ||
                          e.inFor ||
                          this.expect("="),
                      this.finalize(t, new c.VariableDeclarator(i, s))
                    );
                  }),
                  ...
                  (e.prototype.parseVariableStatement = function () {
                    ...
                    return (
                      this.consumeSemicolon(),
                      this.finalize(e, new c.VariableDeclaration(t, "var"))
                    );
                  }),
                  (e.prototype.parseEmptyStatement = function () {
                    var e = this.createNode();
                    return (
                      this.expect(";"), this.finalize(e, new c.EmptyStatement())
                    );
                  }),
                  (e.prototype.parseExpressionStatement = function () {
                    ...
                    return (
                      this.consumeSemicolon(),
                      this.finalize(e, new c.ExpressionStatement(t))
                    );
                  }),
                    ...
                    return (
                      !this.match(")") && this.config.tolerant
                        ? (this.tolerateUnexpectedToken(this.nextToken()),
                          (e = this.finalize(
                            this.createNode(),
                            new c.EmptyStatement()
                          )))
                        : (this.expect(")"),
                          (e = this.parseStatement()),
                          this.matchKeyword("else") &&
                            (this.nextToken(), (r = this.parseStatement()))),
                      this.finalize(t, new c.IfStatement(i, e, r))
                    );
                  }),
                  (e.prototype.parseDoWhileStatement = function () {
                    ...
                    return (
                      ...
                      this.finalize(e, new c.DoWhileStatement(r, i))
                    );
                  }),
                  ...
                  (e.prototype.parseForStatement = function () {
                    ...
                    if (
                      ...
                      if (
                        ...
                        1 === h.length && this.matchKeyword("in"))
                      ) {
                        var p = h[0];
                        p.init &&
                          ...
                          (r = this.finalize(
                            r,
                            new c.VariableDeclaration(h, "var")
                          )),
                          this.nextToken(),
                          (e = r),
                          (t = this.parseExpression()),
                      ...
                      if (
                        ...
                        var l = this.context.allowIn;
                        this.context.allowIn = !1;
                        var h = this.parseBindingList(f, { inFor: !0 });
                        (this.context.allowIn = l),
                          1 === h.length &&
                          null === h[0].init &&
                          this.matchKeyword("in")
                        ...
                        (r = this.finalize(r, new c.Identifier(f))),
                          this.nextToken(),
                          (e = r),
                          (t = this.parseExpression()),
                          (r = null);
                    ...
                    return "undefined" == typeof e
                      ? this.finalize(a, new c.ForStatement(r, i, s, g))
                      : o
                      ? this.finalize(a, new c.ForInStatement(e, t, g))
                      : this.finalize(a, new c.ForOfStatement(e, t, g));
                  }),
                  (e.prototype.parseContinueStatement = function () {
                    ...
                    if (
                      ...
                      Object.prototype.hasOwnProperty.call(
                        ...
                        r
                      ) || this.throwError(n.Messages.UnknownLabel, t.name);
                    }
                    return (
                      this.consumeSemicolon(),
                      null !== t ||
                      ...
                      this.finalize(e, new c.ContinueStatement(t))
                    );
                  }),
                  (e.prototype.parseBreakStatement = function () {
                    ...
                    return (
                      ...
                      this.finalize(e, new c.BreakStatement(t))
                    );
                  }),
                  (e.prototype.parseReturnStatement = function () {
                    ...
                    return (
                      this.consumeSemicolon(),
                      this.finalize(e, new c.ReturnStatement(r))
                    );
                  }),
                  ...
                  (e.prototype.parseSwitchStatement = function () {
                    ...
                    return (
                      ...
                      this.finalize(e, new c.SwitchStatement(t, i))
                    );
                  }),
                  (e.prototype.parseLabelledStatement = function () {
                    ...
                    if (r.type === u.Syntax.Identifier && this.match(":")) {
                      ...
                      delete this.context.labelSet[s],
                        (e = new c.LabeledStatement(i, o));
                    } else
                      this.consumeSemicolon(),
                        (e = new c.ExpressionStatement(r));
                  ...
                  (e.prototype.parseThrowStatement = function () {
                    ...
                    return (
                      this.consumeSemicolon(),
                      this.finalize(e, new c.ThrowStatement(t))
                    );
                  }),
                  (e.prototype.parseCatchClause = function () {
                    ...
                    this.expectKeyword("catch"),
                      ...
                      this.match(")") &&
                        this.throwUnexpectedToken(this.lookahead);
                    for (
                      var t = [], r = this.parsePattern(t), i = {}, s = 0;
                      s < t.length;
                      s++
                    ) {
                      var o = "$" + t[s].value;
                  ...
                  (e.prototype.parseTryStatement = function () {
                    ...
                    var t = this.parseBlock(),
                      ...
                      i = this.matchKeyword("finally")
                        ...
                        : null;
                    return (
                      r || i || this.throwError(n.Messages.NoCatchOrFinally),
                      this.finalize(e, new c.TryStatement(t, r, i))
                    );
                  }),
                  (e.prototype.parseDebuggerStatement = function () {
                    ...
                    return (
                      ...
                      this.consumeSemicolon(),
                      this.finalize(e, new c.DebuggerStatement())
                    );
                  }),
                  ...
                  (e.prototype.parseRestElement = function (e) {
                    ...
                    return (
                      ...
                      this.finalize(t, new c.RestElement(r))
                    );
                  }),
                  ...
                  (e.prototype.parseFunctionDeclaration = function (e) {
                    ...
                    if (!e || !this.match("(")) {
                      ...
                      (s = this.parseVariableIdentifier()),
                        this.context.strict
                          ? this.scanner.isRestrictedWord(a.value) &&
                            this.tolerateUnexpectedToken(
                              a,
                              n.Messages.StrictFunctionName
                            )
                          : this.scanner.isRestrictedWord(a.value)
                          ? ((o = a), (i = n.Messages.StrictFunctionName))
                          : this.scanner.isStrictModeReservedWord(a.value) &&
                            ((o = a), (i = n.Messages.StrictReservedWord));
                    }
                    ...
                    return (
                      ...
                      this.finalize(t, new c.FunctionDeclaration(s, h, d, r))
                    );
                  }),
                  (e.prototype.parseFunctionExpression = function () {
                    ...
                    if (((this.context.allowYield = !t), !this.match("("))) {
                      var a = this.lookahead;
                      (s =
                        this.context.strict || t || !this.matchKeyword("yield")
                        ...
                        this.context.strict
                          ...
                          : this.scanner.isRestrictedWord(a.value)
                          ? ((i = a), (r = n.Messages.StrictFunctionName))
                          : this.scanner.isStrictModeReservedWord(a.value) &&
                            ((i = a), (r = n.Messages.StrictReservedWord));
                    }
                    ...
                    return (
                      ...
                      this.context.strict &&
                        h &&
                        this.tolerateUnexpectedToken(h, r),
                      (this.context.strict = p),
                      (this.context.allowYield = o),
                      this.finalize(e, new c.FunctionExpression(s, l, f, t))
                    );
                  }),
                  (e.prototype.parseDirective = function () {
                    ...
                    return (
                      i.type === u.Syntax.Literal &&
                        (t = this.getTokenRaw(e).slice(1, -1)),
                      this.consumeSemicolon(),
                      this.finalize(
                        r,
                        t ? new c.Directive(i, t) : new c.ExpressionStatement(i)
                      )
                    );
                  }),
                  ...
                  (e.prototype.parseGetterMethod = function () {
                    ...
                    return (
                      ...
                      this.finalize(
                        e,
                        new c.FunctionExpression(null, r.params, n, t)
                      )
                    );
                  }),
                  (e.prototype.parseSetterMethod = function () {
                    var e = this.createNode(),
                      t = { params: [], firstRestricted: null, paramSet: {} },
                      r = !1,
                      i = this.context.allowYield;
                    (this.context.allowYield = !1),
                      this.expect("("),
                    ...
                    return (
                      ...
                      this.finalize(
                        e,
                        new c.FunctionExpression(null, t.params, n, r)
                      )
                    );
                  }),
                  (e.prototype.parseGeneratorMethod = function () {
                    ...
                    return (
                      ...
                      this.finalize(
                        e,
                        new c.FunctionExpression(null, i.params, n, t)
                      )
                    );
                  }),
                  ...
                  (e.prototype.parseClassElement = function (e) {
                    ...
                    return (
                      ...
                      !t &&
                        ...
                        this.match("(") &&
                        ((t = "init"),
                        (i = this.parsePropertyMethodFunction()),
                        (l = !0)),
                      ...
                      u ||
                        ...
                        !h &&
                          ...
                          e.value
                            ...
                            : (e.value = !0),
                          (t = "constructor"))),
                      this.finalize(a, new c.MethodDefinition(r, u, i, t, h))
                    );
                  }),
                  ...
                  (e.prototype.parseClassDeclaration = function (e) {
                    ...
                    var i =
                        e && this.lookahead.type !== o.Token.Identifier
                          ? null
                          : this.parseVariableIdentifier(),
                      n = null;
                    ...
                    return (
                      ...
                      this.finalize(t, new c.ClassDeclaration(i, n, s))
                    );
                  }),
                  (e.prototype.parseClassExpression = function () {
                    ...
                    return (
                      (this.context.strict = t),
                      this.finalize(e, new c.ClassExpression(r, i, n))
                    );
                  }),
                  ...
                  (e.prototype.parseModuleSpecifier = function () {
                    var e = this.createNode();
                    this.lookahead.type !== o.Token.StringLiteral &&
                        ...
                        : ((e = this.parseIdentifierName()),
                          ...
                          this.matchContextualKeyword("as")
                            ? (this.nextToken(),
                              (t = this.parseVariableIdentifier()))
                            : this.throwUnexpectedToken(this.nextToken())),
                      this.finalize(r, new c.ImportSpecifier(t, e))
                    );
                  }),
                  ...
                  (e.prototype.parseImportDeclaration = function () {
                    ...
                    var t,
                      r = [];
                    if (this.lookahead.type === o.Token.StringLiteral)
                    ...
                    return (
                      this.consumeSemicolon(),
                      this.finalize(e, new c.ImportDeclaration(r, t))
                    );
                  }),
                  (e.prototype.parseExportSpecifier = function () {
                    ...
                    return (
                      this.matchContextualKeyword("as") &&
                        (this.nextToken(), (r = this.parseIdentifierName())),
                      this.finalize(e, new c.ExportSpecifier(t, r))
                    );
                  }),
                    ...
                    if (this.matchKeyword("default"))
                      if ((this.nextToken(), this.matchKeyword("function"))) {
                        ...
                        this.consumeSemicolon(),
                          (t = this.finalize(
                            e,
                            new c.ExportDefaultDeclaration(r)
                          ));
                      }
                    else if (this.match("*")) {
                      if (
                      ...
                      this.consumeSemicolon(),
                        (t = this.finalize(e, new c.ExportAllDeclaration(s)));
                      ...
                      t = this.finalize(
                        e,
                        new c.ExportNamedDeclaration(r, [], null)
                      );
                    } else {
                      var a = [],
                        u = null,
                      ...
                      t = this.finalize(
                        e,
                        new c.ExportNamedDeclaration(null, a, u)
                      );
                    }
                    return t;
                  }),
            ...
            var r = (function () {
              ...
              return (
                ...
                (e.prototype.createError = function (e, t, r, i) {
                  ...
                  return (
                    (s.index = e), (s.lineNumber = t), (s.description = i), s
                  );
                }),
          ...
          function (e, t) {
            ...
            !(function (e) {
              (e[(e.BooleanLiteral = 1)] = "BooleanLiteral"),
                ...
                (e[(e.RegularExpression = 9)] = "RegularExpression"),
                (e[(e.Template = 10)] = "Template");
            })(t.Token || (t.Token = {}));
            var r = t.Token;
            (t.TokenName = {}),
              (t.TokenName[r.BooleanLiteral] = "Boolean"),
              (t.TokenName[r.EOF] = "<end>"),
              (t.TokenName[r.Identifier] = "Identifier"),
              (t.TokenName[r.Keyword] = "Keyword"),
              (t.TokenName[r.NullLiteral] = "Null"),
              (t.TokenName[r.NumericLiteral] = "Numeric"),
              (t.TokenName[r.Punctuator] = "Punctuator"),
              (t.TokenName[r.StringLiteral] = "String"),
              (t.TokenName[r.RegularExpression] = "RegularExpression"),
              (t.TokenName[r.Template] = "Template");
          },
          function (e, t, r) {
            "use strict";
            function i(e) {
                ...
                return (
                  ...
                  (e.prototype.tolerateUnexpectedToken = function () {
                    this.errorHandler.tolerateError(
                      ...
                      this.lineNumber,
                      this.index - this.lineStart + 1,
                      o.Messages.UnexpectedTokenIllegal
                    );
                  }),
                  ...
                  (e.prototype.skipMultiLineComment = function () {
                    ...
                    for (
                      ...
                      if (a.Character.isLineTerminator(i))
                        13 === i &&
                  ...
                  (e.prototype.scanComments = function () {
                    ...
                    for (var t = 0 === this.index; !this.eof(); ) {
                      ...
                      else if (a.Character.isLineTerminator(r))
                        ++this.index,
                          13 === r &&
                            10 === this.source.charCodeAt(this.index) &&
                            ++this.index,
                  ...
                  (e.prototype.getComplexIdentifier = function () {
                    ...
                    for (
                      ...
                      a.Character.isIdentifierPart(e));

                    )
                      (r = a.Character.fromCodePoint(e)),
                        (t += r),
                        (this.index += r.length),
                        92 === e &&
                  ...
                  (e.prototype.octalToDecimal = function (e) {
                    ...
                    return (
                      !this.eof() &&
                        ...
                        ((t = !0),
                        (r = 8 * r + n(this.source[this.index++])),
                        "0123".indexOf(e) >= 0 &&
                          !this.eof() &&
                          a.Character.isOctalDigit(
                            this.source.charCodeAt(this.index)
                  ...
                  (e.prototype.scanPunctuator = function () {
                    ...
                    return (
                      this.index === e.start && this.throwUnexpectedToken(),
                      (e.end = this.index),
                      (e.value = t),
                      e
                    );
                  ...
                  (e.prototype.scanBinaryLiteral = function (e) {
                    for (
                      var t, r = "";
                      !this.eof() &&
                      ((t = this.source[this.index]), "0" === t || "1" === t);
                  ...
                  (e.prototype.scanOctalLiteral = function (e, t) {
                    ...
                    for (
                      a.Character.isOctalDigit(e.charCodeAt(0))
                        ? ((i = !0), (r = "0" + this.source[this.index++]))
                        : ++this.index;
                      !this.eof() &&
                      a.Character.isOctalDigit(
                        this.source.charCodeAt(this.index)
                      ...
                      r += this.source[this.index++];
                    return (
                      i || 0 !== r.length || this.throwUnexpectedToken(),
                      (a.Character.isIdentifierStart(
                        this.source.charCodeAt(this.index)
                      ) ||
                    ...
                    for (var r = !1, i = ""; !this.eof(); ) {
                      ...
                      if ("\\" === n)
                        if (
                          ...
                          n && a.Character.isLineTerminator(n.charCodeAt(0)))
                        )
                          ++this.lineNumber,
                            "\r" === n &&
                              "\n" === this.source[this.index] &&
                          ...
                          switch (n) {
                            ...
                            default:
                              if (
                                n &&
                                a.Character.isOctalDigit(n.charCodeAt(0))
                              ) {
                                var c = this.octalToDecimal(n);
                                (r = c.octal || r),
                                  (i += String.fromCharCode(c.code));
                              } else i += n;
                          }
                      else {
                        if (a.Character.isLineTerminator(n.charCodeAt(0)))
                          break;
                        i += n;
                      }
                    }
                    ...
                    for (++this.index; !this.eof(); ) {
                      ...
                      if ("$" === c) {
                        ...
                        if (
                          ...
                          a.Character.isLineTerminator(c.charCodeAt(0)))
                        )
                          ++this.lineNumber,
                            "\r" === c &&
                              "\n" === this.source[this.index] &&
                            ...
                            default:
                              "0" === c
                                ? (a.Character.isDecimalDigit(
                                  ...
                                  (e += "\0"))
                                : a.Character.isOctalDigit(c.charCodeAt(0))
                                ? this.throwUnexpectedToken(
                                    o.Messages.TemplateOctalLiteral
                                  )
                                : (e += c);
                        ...
                        .replace(
                          ...
                          function (e, t, i) {
                            ...
                            return (
                              ...
                              s <= 65535 ? String.fromCharCode(s) : r
                            );
                          }
                        )
                        .replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, r));
                  ...
                  (e.prototype.scanRegExpBody = function () {
                    ...
                    for (
                      var t = this.source[this.index++], r = !1, i = !1;
                      !this.eof();

                    )
                      if (
                        ((e = this.source[this.index++]), (t += e), "\\" === e)
                      )
                        (e = this.source[this.index++]),
                  ...
                  (e.prototype.scanRegExp = function () {
                    ...
                    return {
                      ...
                      regex: { pattern: t.value, flags: r.value },
                      lineNumber: this.lineNumber,
                      lineStart: this.lineStart,
                      start: e,
                      end: this.index,
          ...
          function (e, t, r) {
            ...
            var n,
              ...
              p = r(14);
            !(function (e) {
              (e[(e.Identifier = 100)] = "Identifier"),
                (e[(e.Text = 101)] = "Text");
            })(n || (n = {})),
              (a.TokenName[n.Identifier] = "JSXIdentifier"),
              (a.TokenName[n.Text] = "JSXText");
            var f = (function (e) {
              function t(t, r, i) {
                e.call(this, t, r, i);
              }
              return (
                ...
                (t.prototype.scanXHTMLEntity = function (e) {
                  for (
                    var t = "&", r = !0, i = !1, n = !1, s = !1;
                    !this.scanner.eof() && r && !i;
                      ...
                      switch (t.length) {
                        ...
                        case 3:
                          n &&
                            ((s = "x" === a),
                            (r =
                              s || o.Character.isDecimalDigit(a.charCodeAt(0))),
                            (n = n && !s));
                          break;
                        default:
                          (r =
                            r &&
                            !(
                              n && !o.Character.isDecimalDigit(a.charCodeAt(0))
                            )),
                            (r =
                              r &&
                ...
                (t.prototype.lexJSX = function () {
                  ...
                  if (46 === e) {
                    var c = this.scanner.source.charCodeAt(
                        this.scanner.index + 1
                      ),
                      l = this.scanner.source.charCodeAt(
                ...
                (t.prototype.nextJSXText = function () {
                  ...
                  for (
                    ...
                    ++this.scanner.index,
                      (t += r),
                      o.Character.isLineTerminator(r.charCodeAt(0)) &&
                ...
                (t.prototype.expectJSX = function (e) {
                  ...
                  (t.type === a.Token.Punctuator && t.value === e) ||
                    this.throwUnexpectedToken(t);
                }),
                ...
                (t.prototype.parseJSXIdentifier = function () {
                  var e = this.createJSXNode(),
                    t = this.nextJSXToken();
                  return (
                    t.type !== n.Identifier && this.throwUnexpectedToken(t),
                    this.finalize(e, new p.JSXIdentifier(t.value))
                  );
                }),
                ...
                (t.prototype.parseJSXExpressionAttribute = function () {
                  ...
                  return (
                    this.reenterJSX(),
                    this.finalize(e, new p.JSXExpressionContainer(t))
                  );
                }),
                ...
                (t.prototype.parseJSXNameValueAttribute = function () {
                  ...
                  return (
                    ...
                    this.finalize(e, new p.JSXAttribute(t, r))
                  );
                }),
                (t.prototype.parseJSXSpreadAttribute = function () {
                  ...
                  return (
                    this.reenterJSX(),
                    this.finalize(e, new p.JSXSpreadAttribute(t))
                  );
                }),
                ...
                (t.prototype.parseJSXOpeningElement = function () {
                  ...
                  return (
                    i && this.expectJSX("/"),
                    this.expectJSX(">"),
                    this.finalize(e, new p.JSXOpeningElement(t, i, r))
                  );
                }),
                (t.prototype.parseJSXBoundaryElement = function () {
                  ...
                  if ((this.expectJSX("<"), this.matchJSX("/"))) {
                    ...
                    return (
                      this.expectJSX(">"),
                      this.finalize(e, new p.JSXClosingElement(t))
                    );
                  }
                  ...
                  return (
                    n && this.expectJSX("/"),
                    this.expectJSX(">"),
                    this.finalize(e, new p.JSXOpeningElement(r, n, i))
                  );
                }),
                (t.prototype.parseJSXEmptyExpression = function () {
                  ...
                  return (
                    ...
                    (this.lastMarker.lineNumber = this.scanner.lineNumber),
                    (this.lastMarker.lineStart = this.scanner.lineStart),
                    this.finalize(e, new p.JSXEmptyExpression())
                  );
                }),
                ...
                (t.prototype.parseComplexJSXElement = function (e) {
                  for (var t = []; !this.scanner.eof(); ) {
                    ...
                    if (n.type === l.JSXSyntax.JSXClosingElement) {
                      ...
                      var o = this.finalize(
                        e.node,
                        new p.JSXElement(e.opening, e.children, e.closing)
                      );
              ...
              o = (function () {
                ...
                return (
                  ...
                  (e.prototype.push = function (e) {
                    e.type === s.Token.Punctuator || e.type === s.Token.Keyword
                      ? ("{" === e.value
                      ...
                      if (this.scanner.trackComment)
                        for (var t = 0; t < e.length; ++t) {
                          ...
                          (i = {
                            ...
                            this.trackRange && (i.range = r.range),
    ...
    function (e, t, r) {
      ...
      function i(e, t) {
        ...
        for (r = {}, i = Object.keys(t), n = 0, s = i.length; n < s; n += 1)
          (o = i[n]),
            ...
            u && O.call(u.styleAliases, a) && (a = u.styleAliases[a]),
            (r[o] = a);
        return r;
      }
      function n(e) {
      ...
      function o(e, t) {
        for (
          var r, i = B.repeat(" ", t), n = 0, s = -1, o = "", a = e.length;
          n < a;
      ...
      function f(e, t, r, i, n) {
        ...
        if (t)
          ...
          for (s = 0; s < e.length; s++) {
            if (((o = e.charCodeAt(s)), o === R))
              (a = !0),
                f && ((u = u || (s - d - 1 > i && " " !== e[d + 1])), (d = s));
      ...
      function b(e, t, r) {
        var i,
          ...
          s = "",
          o = e.tag;
        for (i = 0, n = r.length; i < n; i += 1)
          A(e, t, r[i], !1, !1) && (0 !== i && (s += ", "), (s += e.dump));
        (e.tag = o), (e.dump = "[" + s + "]");
      }
      function v(e, t, r, i) {
        var n,
        ...
        for (n = 0, s = f.length; n < s; n += 1)
          (l = ""),
            ...
            A(e, t + 1, o, !0, !0, !0) &&
              ...
              c && (l += e.dump && R === e.dump.charCodeAt(0) ? "?" : "? "),
              (l += e.dump),
              c && (l += a(e, t)),
              A(e, t + 1, u, !0, c) &&
                ((l += e.dump && R === e.dump.charCodeAt(0) ? ":" : ": "),
                (l += e.dump),
                (h += l)));
        (e.tag = p), (e.dump = h || "{}");
      }
      function k(e, t, r) {
        var i, n, s, o, a, u;
        for (
          n = r ? e.explicitTypes : e.implicitTypes, s = 0, o = n.length;
          s < o;
          s += 1
        )
          if (
            ...
            if (((e.tag = r ? a.tag : "?"), a.represent)) {
              if (
                ...
                "[object Function]" === M.call(a.represent))
              )
                i = a.represent(t, u);
              else {
                if (!O.call(a.represent, u))
                  throw new N(
                    "!<" +
                      a.tag +
      ...
      function A(e, t, r, i, n, s) {
        ...
        var a,
          u,
          c = "[object Object]" === o || "[object Array]" === o;
        if (
          (c && ((a = e.duplicates.indexOf(r)), (u = a !== -1)),
          ((null !== e.tag && "?" !== e.tag) ||
            u ||
            (2 !== e.indent && t > 0)) &&
            (n = !1),
          u && e.usedDuplicates[a])
        )
          e.dump = "*ref_" + a;
        else {
          if (
            (c && u && !e.usedDuplicates[a] && (e.usedDuplicates[a] = !0),
            "[object Object]" === o)
          )
            i && 0 !== Object.keys(e.dump).length
              ? (E(e, t, e.dump, n), u && (e.dump = "&ref_" + a + e.dump))
              : (w(e, t, e.dump), u && (e.dump = "&ref_" + a + " " + e.dump));
          else if ("[object Array]" === o)
            i && 0 !== e.dump.length
              ? (v(e, t, e.dump, n), u && (e.dump = "&ref_" + a + e.dump))
              : (b(e, t, e.dump), u && (e.dump = "&ref_" + a + " " + e.dump));
          else {
            if ("[object String]" !== o) {
      ...
      function C(e, t) {
        var r,
          ...
          n = [],
          s = [];
        for (S(e, n, s), r = 0, i = s.length; r < i; r += 1)
          t.duplicates.push(n[s[r]]);
